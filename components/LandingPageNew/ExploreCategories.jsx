  ...
  return (
    ...
    >
      <motion.div
        ...
        className="transition-transform duration-300 hover:scale-105 shadow-lg xl:shadow-xl bg-secondary rounded-lg p-8"
      >
        <div className="grid lg:grid-cols-4 grid-cols-2 gap-4 hover:scale-105 duration-300">
          {/* Heading and Text */}
          <motion.div
            variants={slideFromLeft}
          ...
          {[
            ...
            <motion.div
              ...
              animate={isInView ? "visible" : "hidden"}
            >
              <div className="overflow-hidden transition-transform transform hover:scale-105 duration-300 rounded-lg">
                <img
                  src={item.src}
                  alt={item.alt}
