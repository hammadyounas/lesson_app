  ...
  return (
    <div className="mb-6">
      ...
      >
        ...
        <motion.div
          className={`ml-2 text-gray-600 text-xl transition-transform duration-300 ${isOpen ? 'rotate-180' : ''}`}
        >
          <FiChevronDown />
        </motion.div>
      </motion.div>
      ...
      <hr className="my-4 border-gray-300" /> {/* Horizontal rule for separation */}
    </div>
  );
};
...
const FAQSection = () => {
  ...
  return (
    <div ref={sectionRef} className="bg-white p-6 py-28">
      <main className="flex-grow flex flex-col items-center">
      <motion.h2
  className="lg:text-7xl text-5xl py-9 flex-grow text-left font-bold text-gray-900 sm:mb-10 mb-5"
...
>
  People Also Ask
        ...
        <div className="w-full max-w-xl"> {/* Set a max width for all items */}
          {faqs.map((faq, index) => (
