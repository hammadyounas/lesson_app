...
const PricingCard = ({
  ...
  return (
    <div className="flex flex-col justify-between items-center border-2 rounded-lg h-full w-full border-gray-200 p-6 animate-fade-up animate-delay-300">
      <div className="flex-grow">
        <h2 className="text-2xl font-semibold">{title}</h2>
        <p className="mt-4 text-5xl font-extrabold tracking-tight">{price}<span className="ml-1 text-xl font-semibold">/ month</span></p>
...
const PricingPage = () => {
    ...
    return (
      <div className="relative flex flex-col space-y-10 justify-center items-center bg-white text-black h-screen p-8">
