...
const sampleAssignments = [
  {
    title: "The standards of Technology in Nigeria education",
...
const DashboardPage = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col md:flex-row h-screen bg-gray-100">
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="flex flex-1 space-x-4">
                ...
                <div className="flex-1 flex flex-col space-y-4 bg-white p-4 ml-5 rounded-lg shadow-lg">
                  ...
                  {selectedCourse && (
                    <div className="flex-1 flex flex-col h-full max-h-[700px] bg-blue-100 rounded-lg p-4 shadow-inner overflow-y-auto">
                      {/* Chat Messages */}
